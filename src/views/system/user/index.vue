            ...
            <el-col :span="20" :xs="24">
                <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
                    ...
                    <el-form-item label="手机号码" prop="phonenumber">
                        <el-input @keydown="handleKeydown" type="number" v-model="queryParams.phonenumber"
                            placeholder="请输入手机号码" clearable style="width: 240px" @keyup.enter="handleQuery" />
                    </el-form-item>
...
const handleKeydown = (e) => {
    ...
    if (
        (key === 'e' || isNaN(parseInt(key, 10))) &&
        ![...e.composedPath()].some(el => el.tagName === 'INPUT')
    ) {
