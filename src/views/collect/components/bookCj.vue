    ...
    <div class="form-warp">
        ...
        <el-form :model="form" label-width="120px">
            ...
            <el-form-item label="时间选择：">
                <el-date-picker v-model="form.resource" value-format="YYYY-MM-DD" type="daterange" range-separator="-"
            ...
            <el-form-item>
                ...
                <el-button type="primary">继续采集</el-button>
                <el-button type="primary">进行采集</el-button>
            </el-form-item>
        </el-form>
