<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="水印id" align="center" prop="configName" :show-overflow-tooltip="true" />
            <el-table-column label="水印图片" align="center" prop="configKey" :show-overflow-tooltip="true" />
            <el-table-column label="水印位置" align="center" prop="configKey" :show-overflow-tooltip="true" />
