<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="违禁词" prop="configName">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="primary" @click="addWjcStatus=true">批量新增</el-button>
            </el-col>

            <el-col :span="1.5">
                <el-button type="danger" plain icon="Refresh" @click="handleRefreshCache"
                    v-hasPermi="['system:config:remove']">清空违禁词所有数据</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="违禁词id" align="center" prop="configName" :show-overflow-tooltip="true" />
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="configRef" :model="form"  label-width="80px">
                <el-form-item label="违禁词：" prop="configName" :required="true" >
                    <el-input v-model="form.configName" placeholder="请输入参数名称" />
                </el-form-item>
                <el-form-item label="是否启用" prop="configType">
        ...
        <!-- 批量上传违禁词 -->
         <addWjc :open="addWjcStatus" v-if="addWjcStatus"  @close="addWjcStatus=false" />
         <!-- 上传文件按钮 -->
