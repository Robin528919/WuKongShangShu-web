...
import { getInventoryList } from "@/api/task/index"
import { ElMessage, ElMessageBox } from 'element-plus'
const { page, open, query, transform, tableList, searchFun, resetFun, closeFun, handleCurrentChange, handleSizeChange, getQueryList } = useTableListFun(getInventoryList,{isTb:true})
