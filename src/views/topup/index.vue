            ...
            <div class="payment-method">
                ...
                <el-radio-group v-model="paymentMethod">
                    <el-radio-button label="支付宝">
                        <!-- <img src="https://img.icons8.com/color/48/000000/alipay.png" alt="支付宝" /> -->
                    </el-radio-button>
                    <el-radio-button label="微信支付">
                        <!-- <img src="https://img.icons8.com/color/48/000000/wechat.png" alt="微信支付" /> -->
                    </el-radio-button>
                </el-radio-group>
            </div>
...
export default {
    setup() {
        ...
        const packages = [
            { label: '套餐一：5元，10000个金豆', value: 5 },
            { label: '套餐二：10元，20000个金豆', value: 10 },
            { label: '套餐三：15元，30000个金豆', value: 15 },
            { label: '套餐四：25元，50000个金豆', value: 25 },
            { label: '套餐五：50元，100000个金豆', value: 50 },
            { label: '套餐六：125元，250000个金豆', value: 125 },
            { label: '套餐七：2000元，4000000个金豆', value: 2000 },
        ]
