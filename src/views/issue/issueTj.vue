<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-form-item label="发布总数：" prop="configName">
            ...
            <el-col :span="1.5">
                <el-form-item label="今日发布：" prop="configName">
                    <el-button type="success">个</el-button>
                </el-form-item>
            </el-col>
            <el-col :span="1.5">
                <el-form-item label="昨日发布：" prop="configName">
                    <el-button type="success">个</el-button>
                </el-form-item>
            </el-col>

            <el-col :span="1.5">
                <el-form-item label="一周前发布：" prop="configName">
                    <el-button type="success">个</el-button>
                </el-form-item>
            </el-col>
            <el-col :span="1.5">
                <el-form-item label="本月发布：" prop="configName">
                    <el-button type="success">个</el-button>
                </el-form-item>
            </el-col>
            <el-col :span="1.5">
                <el-form-item label="本年发布：" prop="configName">
                    <el-button type="success">个</el-button>
                </el-form-item>
            </el-col>
        ...
        <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="发布成功" align="center" prop="configName" :show-overflow-tooltip="true" />
            <el-table-column label="预计发布" align="center" prop="configKey" :show-overflow-tooltip="true" />
            <el-table-column label="违禁过滤" align="center" prop="configName" :show-overflow-tooltip="true" />
            <el-table-column label="可发布" align="center" prop="configKey" :show-overflow-tooltip="true" />
            <el-table-column label="发布失败" align="center" prop="configName" :show-overflow-tooltip="true" />
