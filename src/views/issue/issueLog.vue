<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="任务查询" prop="configName">
            ...
            <el-form-item>
                ...
                <el-button type="danger" plain @click="handleRefreshCache">清空店铺任务数据</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="任务id" align="center" prop="configName" :show-overflow-tooltip="true" />
            <el-table-column label="任务名称" align="center" prop="configKey" :show-overflow-tooltip="true" />
            <el-table-column label="任务状态" align="center" prop="configName" :show-overflow-tooltip="true" />
